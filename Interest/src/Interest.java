/* Name: Ansh Verma
 * Course: APComputer Science
 * Period 3
 * 
 * This program takes inputs (Investment; Interest Rate; Annual Deposit; Time) 
 * and use them to create a table the you can use to 
 * tell the total amount of interest over a period of time
 */
...
public class Interest {
	...
	public static void printTable(double investment, double annualDeposit, 
		...
		/* we set the total to how much we invested because 
		 * that is how much we have total right after depositing
		 */
		...
		/* the rest of this method calculates the values needed to be 
		 * printed and then prints them into the table format
		 */
   ...
   /* This is a method that let replicates the \t for strings except 
	* instead of 8 characters per tab,
	* I can use however many I need
	* 
	* I understand that this code is not necessary, however,
	* I feel it makes the program look neater and 
	* it can make the program more reusable for different purposes
	*/
